...
admin.site.site_header = "Crack"
admin.site.site_title = "Crack Admin Portal"
admin.site.index_title = "Crack Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Crack API",
        default_version="v1",
        description="API documentation for Crack App",
    ),
    public=True,
